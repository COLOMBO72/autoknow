      ...
      {locked ? (
        <div style={{ position: "relative" }}>
          {state.data.teaser && (
            <Card style={{ marginBottom: 28, borderColor: tokens.amber }}>
              <p style={{ margin: 0, fontSize: 14 }}>
                Найдено <strong>{state.data.teaser.totalIssues}</strong>{" "}
                {state.data.teaser.totalIssues === 1
                  ? "проблема"
                  : "проблемы/проблем"}
                {state.data.teaser.hasCritical && (
                  <span style={{ color: tokens.red }}> — есть критичные</span>
                )}
                . Плюс расходы на год, страховка, актуальная цена на рынке и
                чек-лист из {state.data.teaser.checklistItemsCount} пунктов
                перед покупкой.
              </p>
            </Card>
          )}
          ...
          <section style={{ marginBottom: 36 }}>
            ...
            >
              <SkeletonCard
                lines={Math.max(3, state.data.teaser?.totalIssues ?? 3)}
              />
            </div>
          </section>
          ...
          <section style={{ marginBottom: 36, position: "relative" }}>
            ...
            >
              <SkeletonCard
                lines={state.data.teaser?.checklistItemsCount ?? 4}
              />
            </div>
                ...
                {unlocking ? (
                  ...
                  <>
                    <div style={{ fontSize: 15 }}>
                      ПОЛУЧИТЬ ВСЮ ИНФОРМАЦИЮ ПО МОДЕЛИ
                    </div>
                    <div
                      style={{
                        fontSize: 22,
        ...
        <>
          ...
          <section style={{ marginBottom: 36 }}>
            ...
            <Card>
              ...
              />
              <p
                style={{ fontSize: 12.5, color: tokens.inkSoft, marginTop: 14 }}
              >
